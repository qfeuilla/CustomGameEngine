...
public:
	...
	IndexedTriangleList(dynamical::VertexBuffer verts_in, std::vector<unsigned short> indices_in)
		:
	...
	{
		using Elements = dynamical::VertexLayout::ElementType;
	...
	void SetNormalsIndependentFlat() noxnd
	{
		...
		using Type = dynamical::VertexLayout::ElementType;
...
public:
	dynamical::VertexBuffer vertices;
