...
namespace Bind
{
	...
	const dynamical::VertexLayout InputLayout::GetLayout() const noexcept
	{
		return layout;
	}
	...
	std::string InputLayout::GenerateUID(const dynamical::VertexLayout& layout, ID3DBlob* pVertexShaderBytecode)
	{
